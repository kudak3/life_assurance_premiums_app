...
public class OnBoarding extends AppCompatActivity {
    ...
    Animation animation, imageAnimation, descAnimation, headingAnimation;
   TextView heading,desc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heading = findViewById(R.id.slider_heading);
        desc = findViewById(R.id.slider_desc);
